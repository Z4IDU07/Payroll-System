...
public class searchEmployee extends javax.swing.JFrame {
    ...
    public searchEmployee() {
        initComponents();
        this.getContentPane().setBackground(Color.decode("#C6E2F8"));
        conn = db.java_db();
        Update_table();
    ...
    private void initComponents() {
        ...
        jPanel4.setBackground(new java.awt.Color(178, 222, 251));
        ...
        txt_search.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        jPanel3.setBackground(new java.awt.Color(178, 222, 251));
        ...
        txt_tel.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        txt_email.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel6.setText("Email :");

        jLabel12.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel12.setText("Gender:");

        r_male.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        r_male.setText("Male");
        ...
        r_female.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_dob.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        jLabel3.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel3.setText("Date of Birth :");

        txt_surname.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_firstname.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_id.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        jLabel15.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel15.setText("Apt./House No :");

        jLabel16.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel16.setText("Post Code :");

        txt_pc.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        txt_apt.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_add2.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        txt_address.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_salary.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        jLabel13.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel13.setText("Basic Salary :");

        jLabel20.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel20.setText("Job Title :");

        txt_doj.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        jLabel19.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel19.setText("Date Hired :");

        jLabel18.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel18.setText("Status :");

        txt_status.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        txt_desig.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        jLabel17.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel17.setText("Designation :");

        jLabel9.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        jLabel9.setText("Department :");

        txt_dep.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        txt_job.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        cmd_delete.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_update.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_emp.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        txt_emp.setText("emp");
    ...
    private void txt_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_updateActionPerformed
        ...
        if (p == 0) {
            ...
            try {
                ...
                String phonePattern = "^\\d{1,10}$";
                String numericPattern = "^\\d+$";

                String value1 = null, value2 = null, value3 = null, value5 = null, value6 = null, value7 = null, value8 = null, value9 = null, value10 = null, value11 = null, value12 = null, value13 = null, value14 = null, value15 = null, value16 = null;

                if (txt_firstname.getText().isEmpty() || !txt_firstname.getText().matches(namePattern)) {
                    JOptionPane.showMessageDialog(null, "first name cannot be empty and should only contain only alphabets");
                    isValid = false;
                } else {
                    value1 = txt_firstname.getText();
                }

                if (txt_surname.getText().isEmpty() || !txt_surname.getText().matches(namePattern)) {
                    JOptionPane.showMessageDialog(null, "surname cannot be empty and should only contain only alphabets");
                    isValid = false;
                } else {
                    value2 = txt_surname.getText();
                }

                if (txt_dob.getText().isEmpty() || !txt_dob.getText().matches(dobPattern)) {
                    JOptionPane.showMessageDialog(null, "dob cannot be empty and should be in dd/mm/yyyy");
                    isValid = false;
                } else {
                    value3 = txt_dob.getText();
                }

                if (txt_email.getText().isEmpty() || !txt_email.getText().matches(emailPattern)) {
                    JOptionPane.showMessageDialog(null, "email cannot be empty and should be in in correct format");
                    isValid = false;
                } else {
                    value5 = txt_email.getText();
                }

                if (txt_tel.getText().isEmpty() || !txt_tel.getText().matches(phonePattern) || txt_tel.getText().length() > 10) {
                    JOptionPane.showMessageDialog(null, "telephone cannot be empty and should not exceed 10 digits");
                    isValid = false;
                } else {
                    value6 = txt_tel.getText();
                }

                if (txt_address.getText().isEmpty() || txt_address.getText().length() > 10) {
                    JOptionPane.showMessageDialog(null, "address field should not be empty and should not exceed 10 characters");
                    isValid = false;
                } else {
                    value7 = txt_address.getText();
                }

                if (!txt_add2.getText().isEmpty() && txt_add2.getText().length() > 10) {
                    JOptionPane.showMessageDialog(null, "address field should not be empty and should not exceed 10 characters");
                    isValid = false;
                } else {
                    value9 = txt_add2.getText();
                }

                if (!txt_apt.getText().isEmpty() && !txt_apt.getText().matches(numericPattern)) {
                    JOptionPane.showMessageDialog(null, "apartment no cannot be empty and should only be numeric");
                    isValid = false;
                } else {
                    value10 = txt_apt.getText();
                }

                if (!txt_pc.getText().isEmpty() && !txt_pc.getText().matches(numericPattern)) {
                    JOptionPane.showMessageDialog(null, "postal code cannot be empty and should only be numeric");
                    isValid = false;
                } else {
                    value11 = txt_pc.getText();
                }

                if (txt_dep.getText().isEmpty() || !txt_dep.getText().matches(namePattern)) {
                    JOptionPane.showMessageDialog(null, "department cannot be empty and should only contain only alphabets");
                    isValid = false;
                } else {
                    value8 = txt_dep.getText();
                }

                if (txt_desig.getText().isEmpty() || !txt_desig.getText().matches(namePattern)) {
                    JOptionPane.showMessageDialog(null, "designation cannot be empty and should only contain only alphabets");
                    isValid = false;
                } else {
                    value12 = txt_desig.getText();
                }

                if (txt_status.getText().isEmpty() || !txt_status.getText().matches(namePattern)) {
                    JOptionPane.showMessageDialog(null, "status cannot be empty and should only contain only alphabets");
                    isValid = false;
                } else {
                    value13 = txt_status.getText();
                }

                if (txt_doj.getText().isEmpty() || !txt_doj.getText().matches(dobPattern)) {
                    JOptionPane.showMessageDialog(null, "doj cannot be empty and should be in dd/mm/yyyy");
                    isValid = false;
                } else {
                    value16 = txt_doj.getText();
                }

                if (txt_salary.getText().isEmpty() || !txt_salary.getText().matches(numericPattern)) {
                    JOptionPane.showMessageDialog(null, "salary cannot be empty and should only be numeric");
                    isValid = false;
                } else {
                    value14 = txt_salary.getText();
                }

                if (txt_job.getText().isEmpty() || !txt_job.getText().matches(namePattern)) {
                    JOptionPane.showMessageDialog(null, "job title cannot be empty and should only contain only alphabets");
                    isValid = false;
                } else {
                    value15 = txt_job.getText();
                }
                ...
                String sql = "update Staff_information set id='" + value4 + "',first_name='" + value1 + "', surname='" + value2 + "', "
                        ...
                        + "Designation ='" + value12 + "', Status ='" + value13 + "', Salary ='" + value14 + "', Gender = '" + gender + "', job_title ='" + value15 + "', Date_Hired ='" + value16 + "'   "
                        + " where id='" + value4 + "' ";
