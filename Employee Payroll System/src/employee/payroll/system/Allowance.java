...
public class Allowance extends javax.swing.JFrame {
    ...
    private void Update_table() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "An error occurred while trying to retrieve the data: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                if (rs != null) {
                    rs.close();
                ...
                JOptionPane.showMessageDialog(null, "An error occurred while trying to close the connection: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(178, 222, 251));

        txt_empid.setEditable(false);
        txt_empid.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_dept.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        jPanel2.setBackground(new java.awt.Color(178, 222, 251));

        txt_med.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        txt_med.setText("0");
        ...
        txt_bonus.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        txt_bonus.setText("0");

        txt_other.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        txt_other.setText("0");
        ...
        txt_hw.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        txt_hw.setText("0");
        ...
        txt_total_overtime.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_per.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        txt_per.setText("0");
        ...
        txt_cal.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        if (txt_empid.getText().equals("")) {
            ...
            if (p == 0) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Error executing SQL statement: " + e.getMessage());
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "Error: " + e.getMessage());
                }
