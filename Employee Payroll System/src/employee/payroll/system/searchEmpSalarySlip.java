...
public class searchEmpSalarySlip extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JFileChooser dialog = new JFileChooser(); //where to save the file
        dialog.setSelectedFile(new File(value + " " + value0 + "-Salary Slip" + ".pdf")); //default file name
        ...
        if (dialogResult == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                float x = Float.valueOf(rs.getString(11)); //11 is the column number of total_allowance
                int v = Integer.parseInt(val);
                float total = calcTotal + x - v;

                Document myDocument = new Document(); //creating a new document
                PdfWriter myWriter = PdfWriter.getInstance(myDocument, new FileOutputStream(filePath));
                myDocument.open(); //opening the document
                ...
                myDocument.add(new Paragraph("Overtime: " + rs.getString(6) + " Hours", FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                ...
                JOptionPane.showMessageDialog(null, "An SQL exception occurred: " + e.getMessage());
            } catch (DocumentException e) {
                JOptionPane.showMessageDialog(null, "A document exception occurred: " + e.getMessage());
            } catch (FileNotFoundException e) {
                JOptionPane.showMessageDialog(null, "The specified file was not found: " + e.getMessage());
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "An unknown exception occurred: " + e.getMessage());
            } finally {
                try {
                    if (rs != null) {
                        rs.close();
                    ...
                    JOptionPane.showMessageDialog(null, "Failed to close the resources: " + e.getMessage());
                }
            }
        }
