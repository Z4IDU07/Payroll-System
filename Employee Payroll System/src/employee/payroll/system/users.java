...
public class users extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmd_add.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_password.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N

        txt_combo.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        txt_username.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
        ...
        cmd_update.setFont(new java.awt.Font("Liberation Sans", 0, 17)); // NOI18N
            ...
            try {
                ...
                if (rs != null) {
                    try {
                        ...
                        // log the error
                        JOptionPane.showMessageDialog(null, "Error closing result set: ");
                    }
                }
                if (pst != null) {
                    try {
                        ...
                        // log the error
                        JOptionPane.showMessageDialog(null, "Error closing prepared statement: ");
                    }
                }
            }
    ...
    private void txt_comboPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_txt_comboPopupMenuWillBecomeInvisible
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error retrieving record: " + e.getMessage());
        } finally {
            // close resources
            if (rs != null) {
                try {
